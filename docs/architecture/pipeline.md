...
| Instruction memory | `instruction_memory_pipe` | M10K synchronous ROM | IMEM_DEPTH × 32 bits |
...
| Data memory | `data_memory_pipe` | M10K synchronous RAM (4 byte-lanes) | DMEM_DEPTH × 32 bits |
...
| CSR file | `csr_file` | Register array (FF) | ~12 registers × 32 bits |
