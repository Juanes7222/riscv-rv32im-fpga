// Combinational control unit for the pipelined RV32IM processor.
// Identical decode logic to control_unit; instantiated in the ID stage.
module control_unit (
    input  logic [6:0]  opcode,
    input  logic [2:0]  funct3,
    input  logic [6:0]  funct7,
    input  logic [11:0] instr_31_20,
        ...
        case (opcode)
            ...
            OP_SYSTEM: begin
                if (funct3 == 3'b000) begin
                    case (instr_31_20)
                        12'h000: trap_entry = 1'b1;
                        12'h001: trap_entry = 1'b1;
                        12'h302: mret_exec  = 1'b1;
                        default: ;
                    endcase
                    ru_wr = 1'b0;
                    br_op = BR_OP_NONE;
